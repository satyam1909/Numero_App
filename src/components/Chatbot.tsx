...
const Chatbot: React.FC<ChatbotProps> = ({ userBirthDate, numerologyData, isOpen, onToggle }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hello! I'm your AI Numerology Assistant. I can help you understand your birth date, personality traits, career paths, relationships, and answer any questions about your numerology profile. What would you like to know?",
      sender: 'bot',
      timestamp: new Date(),
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const context: NumerologyContext = {
        ...
        lifePathNumber: numerologyData?.lifePathNumber || 0,
        personalityNumber: numerologyData?.personalityNumber || 0,
        destinyNumber: numerologyData?.destinyNumber || 0,
        soulUrgeNumber: numerologyData?.soulUrgeNumber || 0,
        expressionNumber: numerologyData?.expressionNumber || 0,
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90">
                      {useExternalLLM ? 'Enhanced AI Mode' : 'Smart Analysis Mode'}
                    </p>
                  </div>
                </div>
